...
def plot_cdf(a):
    ...
    xlabel('Worst case latency')
    ylabel('Fraction of discoveries '+r'F_i(t)')
    plt.show()
    #plt.close()
    print 'gonga....'
#---------------------------------------------------------------------------
                          ...
                          '''END of TX'''   
                            ...
                            for jj, node in enumerate(Lnodes.values()):
                                ...
                                if node.isOwnSlot(slotOffset):
                                    ...
                                    vCh=[nodeC.chId for nodeC in Lnodes.values() if nodeC.isOwnSlot(slotOffset) == True and nodeC.id != node.id]
